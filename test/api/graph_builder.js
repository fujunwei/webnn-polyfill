...
describe('test MLGraphBuilder', async function() {
  ...
  // test constant
  it('MLGraphBuilder should have constant method', () => {
  ...
  it('builder.constant should accept a single-value', () => {
    expect(builder.constant(1)).to.be.an.instanceof(MLOperand);
    expect(builder.constant(1.0)).to.be.an.instanceof(MLOperand);
    expect(builder.constant(0.1)).to.be.an.instanceof(MLOperand);
  });
  ...
  it('builder.add should return an operand', () => {
    ...
    expect(builder.add(a, b)).to.be.an.instanceof(MLOperand);
  });
  ...
  it('builder.mul should return an operand', () => {
    const a = builder.input('a', desc);
    const b = builder.input('b', desc);
    expect(builder.mul(a, b)).to.be.an.instanceof(MLOperand);
  });
  ...
  // test build
  it('builder.build should be a function', () => {
